...
export default function DotsGrid({ className }: { className?: string }) {
  return (
    <div className={clsx("pointer-events-none absolute inset-0 z-0", className)}>
      ...
      <div className="absolute bottom-[-35%] left-1/2 -translate-x-1/2 w-[150%] h-64 bg-gradient-to-t from-violet-800 via-indigo-900 to-transparent blur-3xl opacity-40 z-0" />
    </div>
  );
}